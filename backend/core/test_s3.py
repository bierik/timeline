...
class S3MultipartUploadTestCase(TestCase):
    ...
    def test_uploads_files_in_multiple_parts(self):
        ...
        response = client.client.get_object(Key=key, Bucket=settings.AWS_STORAGE_BUCKET_NAME)
    ...
    def test_abort_multi_part_upload(self):
        ...
        with self.assertRaisesMessage(ClientError, "The specified key does not exist."):
            client.client.get_object(Key=key, Bucket=settings.AWS_STORAGE_BUCKET_NAME)
